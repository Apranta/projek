          ...
          <div class="row">
            <div class="col-sm-6 col-md-6">
              <div class="box box-primary">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo base_url('index.php/pengguna/admin/insert'); ?>">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control" id="nama_admin" name="nama_admin" placeholder="Nama Administrator" required>
                    </div>
                  </div>
                  <div class="form-group">
