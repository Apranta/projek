          ...
          <div class="row">
            <div class="col-sm-6 col-md-6">
              <div class="box box-primary">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo base_url('index.php/pengguna/admin/edit/' . $admin->id_pengguna); ?>">
                <div class="box-body">
            ...
            <div class="col-sm-6 col-md-6">
              <div class="box box-warning">
                ...
                <form class="form-horizontal" action="<?php echo base_url("index.php/pengguna/admin/edit_password/" . $admin->id_pengguna); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                <div class="box-body">
