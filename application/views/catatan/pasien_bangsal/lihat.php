            ...
            <div class="col-sm-6 col-md-6">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Lihat Data Buku Harian</h3>
                </div>
                ...
                <div class="box-footer">
                  <center>
                    ...
                    {
                      if ($bukuharian->paraf_konsulen !== "1")
                      {
                        echo '<a class="btn btn-warning btn-flat" href="'. base_url("index.php/catatanharian/buku_harian/ubah/" . $bukuharian->id) . '">Ubah</a>';
                      }
                    }
                    else
                    {
