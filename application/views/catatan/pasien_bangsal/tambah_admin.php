          ...
          <div class="row">
            <div class="col-sm-6 col-md-6">
              <div class="box box-primary">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo base_url('index.php/catatanharian/buku_harian/insert'); ?>">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <textarea id="catatan_konsulen" name="catatan_konsulen" class="form-control" rows="3" placeholder="Catatan konsulen..."></textarea>
                    </div>
                  </div>
                  <div class="form-group">
