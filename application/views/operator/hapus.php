            ...
            <div class="col-sm-6 col-md-6">
              <div class="box box-primary">
                <div class="box-header">
                  <h3 class="box-title">Hapus Operator</h3>
                </div>
                ...
                <div class="box-footer">
                  <center>
                    ...
                    <a class="btn btn-danger btn-flat" href="<?php echo base_url('index.php/komponen/operator/delete') . '/' . $operator->id; ?>">Hapus</a>
                    <a class="btn btn-default btn-flat" href="<?php echo base_url('index.php/komponen/operator'); ?>">Tidak</a>
                  </center>
                </div>
              </div>              
            </div>
