          ...
          <div class="row">
            <div class="col-sm-6 col-md-6">
              <div class="box box-primary">
                ...
                <form class="form-horizontal" method="POST" action="<?php echo base_url("index.php/komponen/pasien/edit/" . $pasien->no_rm); ?>">
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-9">
                      <input type="text" class="form-control" id="no_rm" name="no_rm" placeholder="No. Rekam Medis" value="<?php echo $pasien->no_rm; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="nama_pasien" class="col-md-3 control-label">Nama Pasien*</label>
                    <div class="col-md-9">
                      <input type="text" class="form-control" id="nama_pasien" name="nama_pasien" placeholder="Nama Pasien" value="<?php echo $pasien->nama_pasien; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="umur" class="col-md-3 control-label">Usia*</label>
                    <div class="col-md-9">
                      <input type="text" class="form-control" id="umur" name="umur" placeholder="Usia" value="<?php echo $pasien->umur; ?>" required>
                    </div>
                  </div>
                  <div class="form-group">
